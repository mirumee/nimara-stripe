...
from .fragments import TransactionChargeRequestedEvent


class TransactionChargeRequested(BaseModel):
    event: Optional[
        Annotated[
            Union[
...
class TransactionChargeRequestedEventEvent(BaseModel):
    typename__: Literal[
...
class TransactionChargeRequestedEventTransactionChargeRequested(
    TransactionChargeRequestedEvent
):
    typename__: Literal["TransactionChargeRequested"] = Field(alias="__typename")


TransactionChargeRequested.model_rebuild()
