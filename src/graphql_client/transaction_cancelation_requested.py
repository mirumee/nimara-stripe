...
from .fragments import TransactionCancelationRequestedEvent


class TransactionCancelationRequested(BaseModel):
    event: Optional[
        Annotated[
            Union[
...
class TransactionCancelationRequestedEventEvent(BaseModel):
    typename__: Literal[
...
class TransactionCancelationRequestedEventTransactionCancelationRequested(
    TransactionCancelationRequestedEvent
):
    typename__: Literal["TransactionCancelationRequested"] = Field(alias="__typename")


TransactionCancelationRequested.model_rebuild()
