...
from .fragments import TransactionProcessSessionEvent


class TransactionProcessSession(BaseModel):
    event: Optional[
        Annotated[
            Union[
...
class TransactionProcessSessionEventEvent(BaseModel):
    typename__: Literal[
...
class TransactionProcessSessionEventTransactionProcessSession(
    TransactionProcessSessionEvent
):
    typename__: Literal["TransactionProcessSession"] = Field(alias="__typename")


TransactionProcessSession.model_rebuild()
