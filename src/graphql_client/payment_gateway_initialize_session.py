...
from .fragments import PaymentGatewayInitializeSessionEvent


class PaymentGatewayInitializeSession(BaseModel):
    event: Optional[
        Annotated[
            Union[
...
class PaymentGatewayInitializeSessionEventEvent(BaseModel):
    typename__: Literal[
...
class PaymentGatewayInitializeSessionEventPaymentGatewayInitializeSession(
    PaymentGatewayInitializeSessionEvent
):
    typename__: Literal["PaymentGatewayInitializeSession"] = Field(alias="__typename")


PaymentGatewayInitializeSession.model_rebuild()
