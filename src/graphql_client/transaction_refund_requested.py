...
from .fragments import TransactionRefundRequestedEvent


class TransactionRefundRequested(BaseModel):
    event: Optional[
        Annotated[
            Union[
...
class TransactionRefundRequestedEventEvent(BaseModel):
    typename__: Literal[
...
class TransactionRefundRequestedEventTransactionRefundRequested(
    TransactionRefundRequestedEvent
):
    typename__: Literal["TransactionRefundRequested"] = Field(alias="__typename")


TransactionRefundRequested.model_rebuild()
